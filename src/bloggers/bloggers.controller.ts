...
export class BloggersController {
    ...
    async getAllBloggers(@Query() query: {searchNameTerm: string, pageNumber: string, pageSize: string, sortBy: string, sortDirection: string}) {
      ...
      const full: object = await this.commandBus.execute(new GetAllBlogsforBloggerCommand(paginationData.pageSize, paginationData.pageNumber, searchNameTerm, paginationData.sortBy, paginationData.sortDirection));
      return full
    }
